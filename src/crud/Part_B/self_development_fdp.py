...
def get_self_development_fdp(db: Session, fdp_id: int) -> Optional[SelfDevelopmentFDP]:
    return db.query(SelfDevelopmentFDP).filter(SelfDevelopmentFDP.id == fdp_id).first()

def get_self_development_fdp_by_faculty(db: Session, faculty_id: int, skip: int = 0, limit: int = 100) -> List[SelfDevelopmentFDP]:
...
def create_self_development_fdp(db: Session, fdp: SelfDevelopmentFDPCreate, faculty_id: int) -> SelfDevelopmentFDP:
...
def update_self_development_fdp_faculty(
    db: Session, fdp_id: int, fdp_update: SelfDevelopmentFDPUpdateFaculty
...
def update_self_development_fdp_hod(
    db: Session, fdp_id: int, fdp_update: SelfDevelopmentFDPUpdateHOD
) -> Optional[SelfDevelopmentFDP]:
    db_fdp = db.query(SelfDevelopmentFDP).filter(SelfDevelopmentFDP.id == fdp_id).first()
    if db_fdp:
...
def update_self_development_fdp_director(
    db: Session, fdp_id: int, fdp_update: SelfDevelopmentFDPUpdateDirector
) -> Optional[SelfDevelopmentFDP]:
    db_fdp = db.query(SelfDevelopmentFDP).filter(SelfDevelopmentFDP.id == fdp_id).first()
    if db_fdp:
...
def delete_self_development_fdp(db: Session, fdp_id: int) -> Optional[SelfDevelopmentFDP]:
    db_fdp = db.query(SelfDevelopmentFDP).filter(SelfDevelopmentFDP.id == fdp_id).first()
    if db_fdp:
        db.delete(db_fdp)
        db.commit()
...
def get_self_development_fdp_total_score(db: Session, faculty_id: int) -> float:
