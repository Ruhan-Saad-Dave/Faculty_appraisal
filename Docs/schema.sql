...
create table public.declarations (
  ...
  part_c_total numeric not null default 0,
...
create table public.event_organisation (
  id uuid primary key default gen_random_uuid(),
  faculty_email text not null,
  academic_year text not null,
  form_family text,
...
create table public.alumni_engagement (
  id uuid primary key default gen_random_uuid(),
  faculty_email text not null,
  academic_year text not null,
  form_family text,
...
create table public.placement_mentoring (
  id uuid primary key default gen_random_uuid(),
  faculty_email text not null,
  academic_year text not null,
  form_family text,
...
create table public.appraisal_reviews (
  ...
  part_c_score numeric not null default 0,
  part_d_score numeric not null default 0,
